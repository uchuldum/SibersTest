...
namespace SibersTest.BL.Services
{
    static internal class CreateByMapper
    {
        ...
        static internal IEnumerable<ProjectDTO> CreateProjectDTOByMapper(IEnumerable<Project> projects)
        {
            if (projects == null)
                return null;
            //  throw new ValidationException("ПРИЛЕТЕЛО НУЛЛ", "");
        ...
        static internal IEnumerable<EmployeeDTO> CreateEmployeeDTOByMapper(IEnumerable<Employee> employees)
        {
            if (employees == null)
                return null;
            //  throw new ValidationException("ПРИЛЕТЕЛО НУЛЛ", "");
